...
--- Note: Salaries table has salary for each employee hence inner join is used otherwise would have used left join
...
SELECT dm.dept_no, d.dept_name, dm.emp_no AS managers_emp_no, 
e.last_name AS managers_last_name, e.first_name AS managers_first_name 
